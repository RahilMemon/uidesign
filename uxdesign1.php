...
<!-- Mirrored from ui8-fleet-html.herokuapp.com/flights.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Dec 2021 11:51:32 GMT -->
  ...
  <body>
    ...
    <div class="outer">
      ...
      <header class="header js-header">
          <div class="header__center center"><a class="header__logo" href="index.html"><img class="some-icon" src="img/content/cleanlogo.png" style="height:80px; width:180px;" alt="Fleet"><img class="some-icon-dark" src="img/content/cleanlogo.png" alt="Fleet"></a>
          <div class="header__wrapper js-header-wrapper">
            <div class="header__item header__item_dropdown js-header-item">
              <button class="header__head js-header-head">Services
            ...
            </div><a class="header__item" href="support.html">Home</a>
        ...
        <div class="section main main_flights">
          <div class="main__center center">
            <div class="main__preview">
              <picture>
                <source media="(max-width: 767px)" srcSet="img/content/cleanmain.jpg"><img src="img/content/cleanmain.jpg" alt="Main">
              </picture>
              <div class="main__wrap">
                <h1 class="main__title hero">30+ Year Exprience </h1>
                <div class="main__info info">Find and book a great experience.</div><a class="button main__button" href="flights-category.html">Book with Us</a>
              </div>
            </div>
        ...
        <div class="section adventure">
          <div class="adventure__center center">
            <div class="adventure__head">
              <h2 class="adventure__title h2">Your Happiness is our priority</h2>
              <div class="adventure__info info">Why Choose Us ?</div>
            </div>
            <div class="adventure__wrapper">
              <div class="adventure__slider js-slider-adventure">
                                <div class="adventure__item">
                                    <div class="adventure__preview"><img src="img/content/L1.png" alt="Adventure"></div>
                                  <div class="adventure__details">
                                    <div class="adventure__subtitle">Highly Rated and Estimated</div><a class="status adventure__places" href="stays-category.html">9,326 places</a>
                                  </div>
                                </div>
                                <div class="adventure__item">
                                    <div class="adventure__preview"><img src="img/content/L2.jpg" alt="Adventure"></div>
                                  <div class="adventure__details">
                                    <div class="adventure__subtitle">Insured & Bonded</div><a class="status adventure__places" href="stays-category.html">12,326 places</a>
                                  </div>
                                </div>
                                <div class="adventure__item">
                                    <div class="adventure__preview"><img src="img/content/L3.jpg" alt="Adventure"></div>
                                  <div class="adventure__details">
                                    <div class="adventure__subtitle">Trusted Services</div><a class="status adventure__places" href="stays-category.html">5,326 places</a>
                                  </div>
                                </div>
                                <div class="adventure__item">
                                  <div class="adventure__preview"><img src="img/content/adventure-pic-1.svg" alt="Adventure"></div>
                                  <div class="adventure__details">
                                    <div class="adventure__subtitle">Professional Quality</div><a class="status adventure__places" href="stays-category.html">9,326 places</a>
                                  </div>
                                </div>
                                <div class="adventure__item">
        ...
        <div class="section travel">
          <div class="travel__center center">
            <div class="travel__head">
              <h2 class="travel__title h2">What Our Client Say ?</h2>
              <div class="travel__info info">Testimonial...</div>
            </div>
              ...
              <div class="travel__col">
                <div class="travel__list">
                  <div class="travel__item">
                    ...
                    <div class="travel__subtitle">100% Recommended</div>
                  ...
                  <div class="travel__item">
                    ...
                    <div class="travel__subtitle">Quality and Trust</div>
                    <div class="travel__content">Stacks is a production-ready library of stackable content blocks built in React Native</div>
                  </div>
                  <div class="travel__item">
                    <div class="travel__number" style="background-color: #58C27D;">03</div>
                    <div class="travel__subtitle">They are the best</div>
                    <div class="travel__content">Stacks is a production-ready library of stackable content blocks built in React Native</div>
                  </div>
                </div><a class="button travel__button" href="stays-category.html">Book With Us</a>
              </div>
              <div class="travel__col">
                <div class="travel__wrapper">
                  <div class="travel__slider js-slider-travel">
                    <div class="travel__gallery">
                        <div class="travel__bg"><img srcSet="img/content/S1.jpg" style="height:900px;width:900px" src="img/content/S1.jpg" alt="Travel"></div>
      ...
      <footer class="footer">
        <div class="footer__center center">
          <div class="footer__row">
              <div class="footer__col"><a class="footer__logo" href="index.html"><img class="some-icon" src="img/content/cleanlogo.png" alt="Fleet" style="height:80px; width:180px;"><img class="some-icon-dark" src="img/content/cleanlogo.png" alt="Fleet"></a>
            ...
            <div class="footer__col">
              <div class="footer__menu"><a class="footer__link" href="index.html">Stays</a><a class="footer__link" href="flights.html">Home</a><a class="footer__link" href="support.html">Support</a><a class="footer__link" href="cars.html">About Us</a><a class="footer__link" href="things-to-do.html">Things to do</a></div>
            </div>
            <div class="footer__col">
...
<!-- Mirrored from ui8-fleet-html.herokuapp.com/flights.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Dec 2021 11:51:33 GMT -->
</html>